---
title: "Starlette 1.0 is here!"
date: 2026-03-22
categories: ["Open Source", "Starlette"]
---

A few weeks after the [1.0.0rc1](https://starlette.dev/release-notes/#100rc1-february-23-2026) release,
we are ready to welcome the [long awaited 1.0](https://www.starlette.io/release-notes/#100). 🎉
...
**First and foremost**, thank you to [Mia Kimberly Christie](https://github.com/lovelydinosaur) for creating Starlette! 🙏
...
Since the [2024 Open Source Report](/blog/open-source-2024), here's what happened
...
consider [sponsoring me on GitHub](https://github.com/sponsors/Kludex). ❤️
